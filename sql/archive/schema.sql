-- Script SQL complet pour DriveLine Customs Manager
...
-- DROP TABLE IF EXISTS public.payroll_settings; -- NOUVEAU
...
-- 6. Table de Configuration Paie (NOUVEAU)
-- Stocke les taux par grade et le % de commission global
CREATE TABLE IF NOT EXISTS public.payroll_settings (
    id INTEGER PRIMARY KEY DEFAULT 1 CHECK (id = 1), -- Assure une seule ligne de config
    commission_rate NUMERIC NOT NULL DEFAULT 0.20,
    grade_rates JSONB NOT NULL DEFAULT '{"mecano_confirme": 1, "mecano_junior": 1, "chef_atelier": 1, "chef_formatrice": 1, "formateur": 1, "patron": 1, "co_patron": 1, "responsable_rh": 1}'::jsonb,
...
-- 7bis. Table des Formations (Catalogue)
...
-- Politiques d'accès (Permissives pour le MVP)
...
-- Mises à jour idempotentes des colonnes manquantes
ALTER TABLE public.time_entries ADD COLUMN IF NOT EXISTS paused BOOLEAN DEFAULT false;
ALTER TABLE public.time_entries ADD COLUMN IF NOT EXISTS pause_started TIMESTAMP WITH TIME ZONE;
ALTER TABLE public.time_entries ADD COLUMN IF NOT EXISTS pause_total_ms NUMERIC DEFAULT 0;
ALTER TABLE public.payroll_settings ADD COLUMN IF NOT EXISTS company_split NUMERIC DEFAULT 0.60;
ALTER TABLE public.payroll_settings ADD COLUMN IF NOT EXISTS safe_balance NUMERIC DEFAULT 0;
ALTER TABLE public.webhook_settings ADD COLUMN IF NOT EXISTS services_status_message_id TEXT DEFAULT '';
ALTER TABLE public.sales ALTER COLUMN client_name DROP NOT NULL;
ALTER TABLE public.sales ADD COLUMN IF NOT EXISTS plate TEXT;
ALTER TABLE public.sales ADD COLUMN IF NOT EXISTS contract_full_perf BOOLEAN DEFAULT false;
ALTER TABLE public.sales ADD COLUMN IF NOT EXISTS contract_full_custom BOOLEAN DEFAULT false;
...
INSERT INTO public.payroll_settings (id, commission_rate, grade_rates)
VALUES (1, 0.20, '{"mecano": 0, "chef_atelier": 0, "responsable_rh": 0, "chef_formatrice": 0, "patron": 0}'::jsonb)
ON CONFLICT (id) DO NOTHING;
...
-- 9. Fonction Reset Week
CREATE OR REPLACE FUNCTION reset_week()
RETURNS void
LANGUAGE plpgsql
AS $$
BEGIN
  -- Supprime toutes les ventes et pointages
